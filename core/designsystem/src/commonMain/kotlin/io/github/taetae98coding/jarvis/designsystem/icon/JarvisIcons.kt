...
object JarvisIcons {
    ...
    internal val all: List<ImageVector>
        get() = listOf(
            Activity, Add, Android, Apple, Back, Backspace, Battery, Calculator, Check, ChevronDown, ChevronLeft, ChevronRight, Claude, Close, Code, Copy,
            Edit, Eye, File, Folder, Forward, GitBranch, Globe, Logs, Monitor, Moon, Pause, Play, Remove, RotateLeft, RotateRight, SkipForward, Smartphone, Sun, Terminal, Timer,
            User, Wifi,
        )
}
