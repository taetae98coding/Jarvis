...
object JarvisIcons {
    ...
    internal val all: List<ImageVector>
        get() = listOf(
            ...
            Forward, GitBranch, Globe, Logs, Monitor, Moon, Pause, Play, PlusMinus, Remove, RotateLeft, RotateRight, Ruler, SkipForward, Smartphone, Sun, Swap,
            Terminal, Timer, Type, User, Wifi,
        )
}
