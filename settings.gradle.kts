...
include(":feature:calculator:domain")
include(":feature:calculator:data")
include(":feature:calculator:ui")

include(":feature:unitconverter:domain")
include(":feature:unitconverter:data")
include(":feature:unitconverter:ui")
