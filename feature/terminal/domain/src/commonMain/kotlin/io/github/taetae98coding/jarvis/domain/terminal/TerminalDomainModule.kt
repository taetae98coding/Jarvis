...
val terminalDomainModule = module {
    ...
    factoryOf(::ObserveCodeAnalysisUseCase)
    factoryOf(::CompleteCodeUseCase)
    factoryOf(::ApplyCodeCompletionUseCase)
    factoryOf(::GoToDeclarationUseCase)
    factoryOf(::FindUsagesUseCase)
